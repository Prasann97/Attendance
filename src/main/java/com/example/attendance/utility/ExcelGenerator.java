	...
	private void writeSubjectHeaders(List<StudentAttendance> StudentAttendanceList,XSSFSheet sheet)
	{
        ...
        if(sheet.equals(CPOS_KH_sheet))
		{
			...
			if(studentAttendance!=null)
			{
		        ...
		        List<Attendance> filteredList=attendanceList.stream().filter(x->x.getSubjectName().equalsIgnoreCase("CPOS")).toList();
        ...
        if(sheet.equals(OOPJ_KH_sheet))
		{
			...
			{
		        List<Attendance> attendanceList=(List<Attendance>) studentAttendance.getDateWiseStudentAttendance()!=null?studentAttendance.getDateWiseStudentAttendance():new ArrayList<Attendance>();
		        List<Attendance> filteredList=attendanceList.stream().filter(x->x.getSubjectName().equalsIgnoreCase("OOPJ")).toList();
		        for(Attendance attendance:filteredList)
		        	createCell(row4, columnCount++, attendance.getAttendanceDate().toString(), style,sheet);
		        createCell(row4, columnCount++, "Total("+filteredList.size()+")", style,sheet);
		        createCell(row4, columnCount, "%", style,sheet);
		...
		else if(sheet.equals(ADS_KH_sheet))
		{
			...
			{
		        List<Attendance> attendanceList=(List<Attendance>) studentAttendance.getDateWiseStudentAttendance()!=null?studentAttendance.getDateWiseStudentAttendance():new ArrayList<Attendance>();
		        List<Attendance> filteredList=attendanceList.stream().filter(x->x.getSubjectName().equalsIgnoreCase("ADS")).toList();
		        for(Attendance attendance:filteredList)
		        	createCell(row4, columnCount++, attendance.getAttendanceDate().toString(), style,sheet);
		        createCell(row4, columnCount++, "Total("+filteredList.size()+")", style,sheet);
		        createCell(row4, columnCount, "%", style,sheet);
		...
		else if(sheet.equals(DBT_KH_sheet))
		{
			...
			{
		        List<Attendance> attendanceList=(List<Attendance>) studentAttendance.getDateWiseStudentAttendance()!=null?studentAttendance.getDateWiseStudentAttendance():new ArrayList<Attendance>();
		        List<Attendance> filteredList=attendanceList.stream().filter(x->x.getSubjectName().equalsIgnoreCase("DBT")).toList();
		        for(Attendance attendance:filteredList)
		        	createCell(row4, columnCount++, attendance.getAttendanceDate().toString(), style,sheet);
		        createCell(row4, columnCount++, "Total("+filteredList.size()+")", style,sheet);
		        createCell(row4, columnCount, "%", style,sheet);
		...
		else if(sheet.equals(SE_KH_sheet))
		{
			...
			{
		        List<Attendance> attendanceList=(List<Attendance>) studentAttendance.getDateWiseStudentAttendance()!=null?studentAttendance.getDateWiseStudentAttendance():new ArrayList<Attendance>();
		        List<Attendance> filteredList=attendanceList.stream().filter(x->x.getSubjectName().equalsIgnoreCase("SE")).toList();
		        for(Attendance attendance:filteredList)
		        	createCell(row4, columnCount++, attendance.getAttendanceDate().toString(), style,sheet);
		        createCell(row4, columnCount++, "Total("+filteredList.size()+")", style,sheet);
		        createCell(row4, columnCount, "%", style,sheet);
		...
		else if(sheet.equals(WPT_KH_sheet))
		{
			...
			{
		        List<Attendance> attendanceList=(List<Attendance>) studentAttendance.getDateWiseStudentAttendance()!=null?studentAttendance.getDateWiseStudentAttendance():new ArrayList<Attendance>();
		        List<Attendance> filteredList=attendanceList.stream().filter(x->x.getSubjectName().equalsIgnoreCase("WPT")).toList();
		        for(Attendance attendance:filteredList)
		        	createCell(row4, columnCount++, attendance.getAttendanceDate().toString(), style,sheet);
		        createCell(row4, columnCount++, "Total("+filteredList.size()+")", style,sheet);
		        createCell(row4, columnCount, "%", style,sheet);
		...
		else if(sheet.equals(WJP_KH_sheet))
		{
			...
			{
		        List<Attendance> attendanceList=(List<Attendance>) studentAttendance.getDateWiseStudentAttendance()!=null?studentAttendance.getDateWiseStudentAttendance():new ArrayList<Attendance>();
		        List<Attendance> filteredList=attendanceList.stream().filter(x->x.getSubjectName().equalsIgnoreCase("WJP")).toList();
		        for(Attendance attendance:filteredList)
		        	createCell(row4, columnCount++, attendance.getAttendanceDate().toString(), style,sheet);
		        createCell(row4, columnCount++, "Total("+filteredList.size()+")", style,sheet);
		        createCell(row4, columnCount, "%", style,sheet);
		...
		else if(sheet.equals(MS_NET_KH_sheet))
		{
			...
			{
		        List<Attendance> attendanceList=(List<Attendance>) studentAttendance.getDateWiseStudentAttendance()!=null?studentAttendance.getDateWiseStudentAttendance():new ArrayList<Attendance>();
		        List<Attendance> filteredList=attendanceList.stream().filter(x->x.getSubjectName().equalsIgnoreCase("MS.NET")).toList();
		        for(Attendance attendance:filteredList)
		        	createCell(row4, columnCount++, attendance.getAttendanceDate().toString(), style,sheet);
		        createCell(row4, columnCount++, "Total("+filteredList.size()+")", style,sheet);
		        createCell(row4, columnCount, "%", style,sheet);
		...
		else if(sheet.equals(SDM_KH_sheet))
		{
			...
			{
		        List<Attendance> attendanceList=(List<Attendance>) studentAttendance.getDateWiseStudentAttendance()!=null?studentAttendance.getDateWiseStudentAttendance():new ArrayList<Attendance>();
		        List<Attendance> filteredList=attendanceList.stream().filter(x->x.getSubjectName().equalsIgnoreCase("SDM")).toList();
		        for(Attendance attendance:filteredList)
		        	createCell(row4, columnCount++, attendance.getAttendanceDate().toString(), style,sheet);
		        createCell(row4, columnCount++, "Total("+filteredList.size()+")", style,sheet);
		        createCell(row4, columnCount, "%", style,sheet);
		...
		else if(sheet.equals(KH_sheet))
		{
			...
			if(studentAttendance!=null)
			{
				createCell(row4, columnCount++, ApplicationConstants.CPOS+"("+studentAttendance.getDateWiseStudentAttendance().stream().filter(x->x.getSubjectName().equalsIgnoreCase(ApplicationConstants.CPOS)).toList().size()+")", style, sheet);
				createCell(row4, columnCount++, ApplicationConstants.OOPJ+"("+studentAttendance.getDateWiseStudentAttendance().stream().filter(x->x.getSubjectName().equalsIgnoreCase(ApplicationConstants.OOPJ)).toList().size()+")", style, sheet);
				createCell(row4, columnCount++, ApplicationConstants.ADS+"("+studentAttendance.getDateWiseStudentAttendance().stream().filter(x->x.getSubjectName().equalsIgnoreCase(ApplicationConstants.ADS)).toList().size()+")", style, sheet);
				createCell(row4, columnCount++, ApplicationConstants.SDM+"("+studentAttendance.getDateWiseStudentAttendance().stream().filter(x->x.getSubjectName().equalsIgnoreCase(ApplicationConstants.SDM)).toList().size()+")", style, sheet);
				createCell(row4, columnCount++, ApplicationConstants.DBT+"("+studentAttendance.getDateWiseStudentAttendance().stream().filter(x->x.getSubjectName().equalsIgnoreCase(ApplicationConstants.DBT)).toList().size()+")", style, sheet);
				createCell(row4, columnCount++, ApplicationConstants.WPT+"("+studentAttendance.getDateWiseStudentAttendance().stream().filter(x->x.getSubjectName().equalsIgnoreCase(ApplicationConstants.WPT)).toList().size()+")", style, sheet);
				createCell(row4, columnCount++, ApplicationConstants.WJP+"("+studentAttendance.getDateWiseStudentAttendance().stream().filter(x->x.getSubjectName().equalsIgnoreCase(ApplicationConstants.WJP)).toList().size()+")", style, sheet);
				createCell(row4, columnCount++, ApplicationConstants.MS_NET+"("+studentAttendance.getDateWiseStudentAttendance().stream().filter(x->x.getSubjectName().equalsIgnoreCase(ApplicationConstants.MS_NET)).toList().size()+")", style, sheet);
				createCell(row4, columnCount++, ApplicationConstants.SE+"("+studentAttendance.getDateWiseStudentAttendance().stream().filter(x->x.getSubjectName().equalsIgnoreCase(ApplicationConstants.SE)).toList().size()+")", style, sheet);
...
//			}
	...
	private void writeData(XSSFSheet sheet)
	{
		...
		if(sheet.equals(OOPJ_KH_sheet))
		{
			List<StudentAttendance> filteredStudentAttendanceList =studentList.stream().filter(x->x.getStudent().getCenterName().equalsIgnoreCase("Kharghar")).toList();
			for (int i = 0; i < filteredStudentAttendanceList.size(); i++) {
				...
				List<Attendance> filteredAttendanceList = filteredStudentAttendanceList.get(i)
						...
						.filter(x -> x.getSubjectName().equalsIgnoreCase("JAVA")).toList();
		...
		{
			List<StudentAttendance> filteredStudentAttendanceList =studentList.stream().filter(x->x.getStudent().getCenterName().equalsIgnoreCase("Juhu")).toList();
			for (int i = 0; i < filteredStudentAttendanceList.size(); i++) {
				Row row = sheet.createRow(rowCount++);
				int columnCount = 0;
				createCell(row, columnCount++, count++, style, sheet);
		...
		else if(sheet.equals(CPOS_KH_sheet))
		{
			...
			for (int i = 0; i < filteredStudentAttendanceList.size(); i++) {
				...
				List<Attendance> filteredAttendanceList = filteredStudentAttendanceList.get(i)
						.getDateWiseStudentAttendance().stream()
						.filter(x -> x.getSubjectName().equalsIgnoreCase("CPOS")).toList();
				for (Attendance attendance : filteredAttendanceList) {
					createCell(row, columnCount++, attendance.isStatus() ? "P" : "AB", style, sheet);
					if (attendance.isStatus())
						presentCounter++;
		...
		else if(sheet.equals(ADS_KH_sheet))
		{
			...
			for (int i = 0; i < filteredStudentAttendanceList.size(); i++) {
				...
				List<Attendance> filteredAttendanceList = filteredStudentAttendanceList.get(i)
						.getDateWiseStudentAttendance().stream()
						.filter(x -> x.getSubjectName().equalsIgnoreCase("ADS")).toList();
				for (Attendance attendance : filteredAttendanceList) {
					createCell(row, columnCount++, attendance.isStatus() ? "P" : "AB", style, sheet);
					if (attendance.isStatus())
						presentCounter++;
		...
		else if(sheet.equals(DBT_KH_sheet))
		{
			...
			for (int i = 0; i < filteredStudentAttendanceList.size(); i++) {
				...
				List<Attendance> filteredAttendanceList = filteredStudentAttendanceList.get(i)
						.getDateWiseStudentAttendance().stream()
						.filter(x -> x.getSubjectName().equalsIgnoreCase("DBT")).toList();
				for (Attendance attendance : filteredAttendanceList) {
					createCell(row, columnCount++, attendance.isStatus() ? "P" : "AB", style, sheet);
					if (attendance.isStatus())
						presentCounter++;
		...
		else if(sheet.equals(SE_KH_sheet))
		{
			...
			for (int i = 0; i < filteredStudentAttendanceList.size(); i++) {
				...
				List<Attendance> filteredAttendanceList = filteredStudentAttendanceList.get(i)
						.getDateWiseStudentAttendance().stream()
						.filter(x -> x.getSubjectName().equalsIgnoreCase("SE")).toList();
				for (Attendance attendance : filteredAttendanceList) {
					createCell(row, columnCount++, attendance.isStatus() ? "P" : "AB", style, sheet);
					if (attendance.isStatus())
						presentCounter++;
		...
		else if(sheet.equals(WPT_KH_sheet))
		{
			...
			for (int i = 0; i < filteredStudentAttendanceList.size(); i++) {
				...
				List<Attendance> filteredAttendanceList = filteredStudentAttendanceList.get(i)
						.getDateWiseStudentAttendance().stream()
						.filter(x -> x.getSubjectName().equalsIgnoreCase("WPT")).toList();
				for (Attendance attendance : filteredAttendanceList) {
					createCell(row, columnCount++, attendance.isStatus() ? "P" : "AB", style, sheet);
					if (attendance.isStatus())
						presentCounter++;
		...
		else if(sheet.equals(WJP_KH_sheet))
		{
			...
			for (int i = 0; i < filteredStudentAttendanceList.size(); i++) {
				...
				List<Attendance> filteredAttendanceList = filteredStudentAttendanceList.get(i)
						.getDateWiseStudentAttendance().stream()
						.filter(x -> x.getSubjectName().equalsIgnoreCase("WJP")).toList();
				for (Attendance attendance : filteredAttendanceList) {
					createCell(row, columnCount++, attendance.isStatus() ? "P" : "AB", style, sheet);
					if (attendance.isStatus())
						presentCounter++;
		...
		else if(sheet.equals(MS_NET_KH_sheet))
		{
			...
			for (int i = 0; i < filteredStudentAttendanceList.size(); i++) {
				...
				List<Attendance> filteredAttendanceList = filteredStudentAttendanceList.get(i)
						.getDateWiseStudentAttendance().stream()
						.filter(x -> x.getSubjectName().equalsIgnoreCase("MS.NET")).toList();
				for (Attendance attendance : filteredAttendanceList) {
					createCell(row, columnCount++, attendance.isStatus() ? "P" : "AB", style, sheet);
					if (attendance.isStatus())
						presentCounter++;
		...
		else if(sheet.equals(SDM_KH_sheet))
		{
			...
			for (int i = 0; i < filteredStudentAttendanceList.size(); i++) {
				...
				List<Attendance> filteredAttendanceList = filteredStudentAttendanceList.get(i)
						.getDateWiseStudentAttendance().stream()
						.filter(x -> x.getSubjectName().equalsIgnoreCase("SDM")).toList();
				for (Attendance attendance : filteredAttendanceList) {
					createCell(row, columnCount++, attendance.isStatus() ? "P" : "AB", style, sheet);
					if (attendance.isStatus())
						presentCounter++;

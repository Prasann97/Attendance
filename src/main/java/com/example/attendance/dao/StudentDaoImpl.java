...
public class StudentDaoImpl implements StudentDao{
	...
	public List<StudentAttendance> getAllStudents() {
		...
		for(StudentAttendance studentAttendance:StudentAttendanceList)
		{
			...
			totalStudentwiseAttendance.put(ApplicationConstants.CPOS,studentAttendance.getDateWiseStudentAttendance().stream().filter(x->x.getSubjectName().equalsIgnoreCase(ApplicationConstants.CPOS)).filter(x->x.isStatus()==true).toList().size());
			totalStudentwiseAttendance.put(ApplicationConstants.OOPJ,studentAttendance.getDateWiseStudentAttendance().stream().filter(x->x.getSubjectName().equalsIgnoreCase(ApplicationConstants.OOPJ)).filter(x->x.isStatus()==true).toList().size());
			totalStudentwiseAttendance.put(ApplicationConstants.ADS,studentAttendance.getDateWiseStudentAttendance().stream().filter(x->x.getSubjectName().equalsIgnoreCase(ApplicationConstants.ADS)).filter(x->x.isStatus()==true).toList().size());
			totalStudentwiseAttendance.put(ApplicationConstants.SDM,studentAttendance.getDateWiseStudentAttendance().stream().filter(x->x.getSubjectName().equalsIgnoreCase(ApplicationConstants.SDM)).filter(x->x.isStatus()==true).toList().size());
			totalStudentwiseAttendance.put(ApplicationConstants.DBT,studentAttendance.getDateWiseStudentAttendance().stream().filter(x->x.getSubjectName().equalsIgnoreCase(ApplicationConstants.DBT)).filter(x->x.isStatus()==true).toList().size());
			totalStudentwiseAttendance.put(ApplicationConstants.WPT,studentAttendance.getDateWiseStudentAttendance().stream().filter(x->x.getSubjectName().equalsIgnoreCase(ApplicationConstants.WPT)).filter(x->x.isStatus()==true).toList().size());
			totalStudentwiseAttendance.put(ApplicationConstants.WJP,studentAttendance.getDateWiseStudentAttendance().stream().filter(x->x.getSubjectName().equalsIgnoreCase(ApplicationConstants.WJP)).filter(x->x.isStatus()==true).toList().size());
			totalStudentwiseAttendance.put(ApplicationConstants.MS_NET,studentAttendance.getDateWiseStudentAttendance().stream().filter(x->x.getSubjectName().equalsIgnoreCase(ApplicationConstants.MS_NET)).filter(x->x.isStatus()==true).toList().size());
			totalStudentwiseAttendance.put(ApplicationConstants.SE,studentAttendance.getDateWiseStudentAttendance().stream().filter(x->x.getSubjectName().equalsIgnoreCase(ApplicationConstants.SE)).filter(x->x.isStatus()==true).toList().size());
